...
st.markdown("""
    ...
    House & Browse visualizes housing prices across 30 major U.S. metropolitan areas from 2012 to 2023. Using metrics such as median sale price and price-to-income ratio, this app provides interactive tools to explore the affordability trends and identify which areas are attainable based on a user's income.

    ### 🧮 How Price-to-Income Ratio Works
    - Price-to-Income Ratio = **Median Sale Price ÷ Median Household Income**
    - Median Household Income = 2.54 * Median Income (2019 to 2023 Median U.S. household size = 2.54)
